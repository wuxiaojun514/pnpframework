...
using PnP.Framework.Provisioning.Providers.Xml.V202604;
using TargetNamespace = PnP.Framework.Provisioning.Providers.Xml.V202604;
using TargetSerializer = PnP.Framework.Provisioning.Providers.Xml.XMLPnPSchemaV202604Serializer;
using TargetProvisioning = PnP.Framework.Provisioning.Providers.Xml.V202604.Provisioning;
...
namespace PnP.Framework.Test.Framework.Providers
{
    ...
    /// </summary>
    [TestClass]
    public class XMLSerializer202604Tests
    {
        #region Test variables
        private const string TEST_CATEGORY = "Framework Provisioning XML Serialization\\Deserialization 202604";
        private const string TEST_OUT_FILE = "ProvisioningTemplate-2026-04-Sample-01-test.xml";
        private const string TEST_TEMPLATE = "ProvisioningSchema-2026-04-FullSample-01.xml";
